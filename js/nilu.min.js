! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).nilu2 = e() }(this, function() {
    "use strict";
    ...
    function ye(t) {
        ...
        i && (t = function(t) { return void 0 !== t ? c({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, t) : { isConfirmed: !1, isDenied: !1, isDismissed: !0 } }(t), (e = Ot.innerParams.get(this)) && !F(i, e.hideClass.popup) && (n = ge.swalPromiseResolve.get(this), yt(i, e.showClass.popup), vt(i, e.hideClass.popup), o = C(), yt(o, e.showClass.backdrop), vt(o, e.hideClass.backdrop), function(t, e, n) {
            var o = C(),
                ...
                s = n.willClose,
                c = n.didClose;
            if (be(e, s, r), i) { we(t, e, o, c !== null && c !== void 0 ? c : a) } else { ve(t, o, G(), c !== null && c !== void 0 ? c : a) }
        }(this, i, e), n(t)))
    }
    ...
    function Ae(t) {
        var e, n;
        (e = t).inputValidator || Object.keys(Pe).forEach(function(t) { e.input === t && (e.inputValidator = Pe[t]) }), t.showLoaderOnConfirm && !t.preConfirm && K("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://nilu2.github.io/#ajax-request"), t.animation = Q(t.animation), (n = t).target && ("string" != typeof n.target || document.querySelector(n.target)) && ("string" == typeof n.target || n.target.appendChild) || (K('Target parameter is not valid, defaulting to "body"'), n.target = "body"), "string" == typeof t.title && (t.title = t.title.split("\n").join("<br />")), kt(t)
    }
    ...
    var Ve = function(t, e) { "function" == typeof e.didOpen ? setTimeout(function() { return e.didOpen(t) }) : "function" == typeof e.onOpen && setTimeout(function() { return e.onOpen(t) }) },
        ...
        Ne = function(t, e, n) { vt(t, n.showClass.backdrop), e.style.setProperty("opacity", "0", "important"), rt(e), setTimeout(function() { vt(e, n.showClass.popup), e.style.removeProperty("opacity") }), vt([document.documentElement, document.body], J.shown), n.heightAuto && n.backdrop && !n.toast && vt([document.documentElement, document.body], J["height-auto"]) },
    ...
    var hn, gn = function(t) { for (var e in t) t[e] = new WeakMap },
        vn = Object.freeze({
            ...
            update: function(e) {
                ...
                var o = {};
                Object.keys(e).forEach(function(t) { bn.isUpdatableParameter(t) ? o[t] = e[t] : K('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/nilu2/nilu2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/nilu2/nilu2/issues/new?template=02_feature_request.md')) });
                var i = c({}, n, o);
        ...
        yn = function() {
            function r() {
                if (a(this, r), "undefined" != typeof window) {
                    "undefined" == typeof Promise && Y("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/nilu2/nilu2/wiki/Migration-from-SweetAlert-to-nilu2#1-ie-support)"), hn = this;
    ...
    c(yn.prototype, vn), c(yn, ce), Object.keys(vn).forEach(function(t) { yn[t] = function() { if (hn) return hn[t].apply(hn, arguments) } }), yn.DismissReason = $, yn.version = "10.3.1";
    var bn = yn;
    return bn.default = bn
}), void 0 !== this && this.nilu2 && (this.swal = this.sweetAlert = this.Swal = this.SweetAlert = this.nilu2);